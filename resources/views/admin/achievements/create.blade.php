...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold text-gray-800">Create Achievement</h2>
        <a href="{{ route('admin.achievements.index') }}" class="px-4 py-2 border rounded">Back</a>
    </div>
    ...
    <div class="bg-white rounded shadow p-5">
        <form method="POST" action="{{ route('admin.achievements.store') }}" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex gap-2">
                ...
                <a href="{{ route('admin.achievements.index') }}" class="px-4 py-2 border rounded">Cancel</a>
            </div>
        </form>
    </div>
@endsection
